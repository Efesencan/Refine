...
def main():
    ...
    iterations = 1  # Number of iterations to repeat the process
    ...
    directory_path = "/projectnb/peaclab-mon/sencan/robust_prodigy/robust_prodigy_single_iteration"
    # Constructing the filename with variable values
    # Construct the filename with variable values
    filename = f"{directory_path}/single_iteration_robust_prodigy_{str(anomaly_ratio)}%_cv_{CV_INDEX}_{SYSTEM}.csv"
