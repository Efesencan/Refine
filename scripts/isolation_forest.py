...
def main():
    ...
    y_scores = -model.decision_function(test_data)  # Scores need to be flipped for AUC

    auc_score = roc_auc_score(y_test_auc, y_scores)
    ...
    filename = f"isolation_forest_robust_prodigy_{str(anomaly_ratio)}%_cv_{CV_INDEX}_{SYSTEM}.csv"
